...
export async function list_tickets(req:any,res:any){res.json(await service.list_tickets({...req.body, __actor: req.user}, req.params, req.query));}
export async function get_ticket(req:any,res:any){res.json(await service.get_ticket({...req.body, __actor: req.user}, req.params, req.query));}
